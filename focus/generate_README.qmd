...
In the online setting, the quantile vector must be provided when creating the detector. The statististic can be retrieved as usual, however it will be a vector of length 2 (sum and max statistics).
