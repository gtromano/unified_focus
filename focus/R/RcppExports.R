...
detector_create <- function(info, theta0 = NULL, dim_indexes = NULL, pruning_mult = 2L, pruning_offset = 1L, side = "right") {
    .Call(`_focus_detector_create`, info, theta0, dim_indexes, pruning_mult, pruning_offset, side)
}
