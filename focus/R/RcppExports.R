...
Focus_arp_rcpp <- function(data_point_rcpp, rho_rcpp, lambda, pre_change_mean = NULL) {
    .Call(`_focus_Focus_arp_rcpp`, data_point_rcpp, rho_rcpp, lambda, pre_change_mean)
}

Focus_arp_rcpp_up_only <- function(data_point_rcpp, rho_rcpp, lambda, pre_change_mean = NULL) {
    .Call(`_focus_Focus_arp_rcpp_up_only`, data_point_rcpp, rho_rcpp, lambda, pre_change_mean)
}
