...
detector_create <- function(type, theta0 = NULL, dim_indexes = NULL, quantiles = NULL, pruning_mult = 2L, pruning_offset = 1L, side = "right") {
    .Call(`_focus_detector_create`, type, theta0, dim_indexes, quantiles, pruning_mult, pruning_offset, side)
}
...
focus_offline <- function(Y, threshold, type, family, theta0 = NULL, dim_indexes = NULL, quantiles = NULL, pruning_mult = 2L, pruning_offset = 1L, side = "right", shape = NULL) {
